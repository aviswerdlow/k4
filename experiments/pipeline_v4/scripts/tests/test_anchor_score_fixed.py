...
class TestAnchorScoring(unittest.TestCase):
    ...
    def test_windowed_mode_outside_radius(self):
        ...
        self.assertEqual(result['per_anchor']['EAST']['score'], 0)  # Not found
    ...
    def test_typo_tolerance(self):
        ...
        self.assertGreaterEqual(result['per_anchor']['EAST']['score'], 3)  # Partial credit
    ...
    def test_shuffled_mode(self):
        ...
        self.assertEqual(result['per_anchor']['EAST']['score'], 4)  # Found anywhere
        self.assertEqual(result['per_anchor']['EAST']['position'], 40)
    ...
    def test_no_anchors_present(self):
        ...
        self.assertEqual(result['per_anchor']['EAST']['score'], 0)
        self.assertEqual(result['per_anchor']['NORTHEAST']['score'], 0)
        self.assertEqual(result['per_anchor']['BERLINCLOCK']['score'], 0)
    ...
    def test_overlapping_anchors(self):
        ...
        self.assertEqual(result['per_anchor']['EAST']['score'], 4)
        self.assertEqual(result['per_anchor']['NORTHEAST']['score'], 9)
        self.assertEqual(result['anchor_score'], 13)
    ...
    def test_window_search_order(self):
        ...
        self.assertEqual(result['per_anchor']['EAST']['position'], 20)  # Closer one found
    ...
    def test_scoring_before_blinding(self):
        ...
        self.assertEqual(result['per_anchor']['NORTHEAST']['score'], 9)
        self.assertEqual(result['per_anchor']['BERLINCLOCK']['score'], 11)
        self.assertEqual(result['anchor_score'], 24)
        
        # The positions should be exact
        self.assertEqual(result['per_anchor']['EAST']['position'], 21)
        self.assertEqual(result['per_anchor']['NORTHEAST']['position'], 25)
        self.assertEqual(result['per_anchor']['BERLINCLOCK']['position'], 63)
...
class TestWindowedSearch(unittest.TestCase):
    ...
    def test_window_radius_2(self):
        ...
        for pos, should_find in positions_to_test:
            ...
            if should_find:
                self.assertEqual(
                    result['per_anchor']['EAST']['score'], 4,
                    f"Should find EAST at position {pos} with radius 2"
                )
            else:
                self.assertEqual(
                    result['per_anchor']['EAST']['score'], 0,
