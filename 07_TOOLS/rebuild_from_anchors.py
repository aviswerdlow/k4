...
def main():
    ...
    print("KEY INSIGHTS:")
    print("=" * 70)
    print(f"1. Anchors determine {stats['plaintext_indices_covered']}/97 plaintext positions through algebraic constraints")
    print(f"2. The remaining {stats['plaintext_indices_uncovered']} positions REQUIRE additional information for unique determination")
